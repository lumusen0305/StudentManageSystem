...
function xmailAutoLogin(a)
{
var b;
if(isXmailSidExpired())
{
...
{
var c=new Date();
c.setTime(c.getTime()+VALID_TIME);
setCookie('xm_sid',d.body.xm_sid,c,'/','mail.qq.com',true,false);
setCookie('xm_skey',d.body.xm_skey,c,'/','mail.qq.com',true,false);
setCookie('xm_uin',d.body.xm_uin,c,'/','mail.qq.com',true,false);
}
else{
...
function doRawXmailRequest(a,e,h,d)
{
if(a.indexOf('/')===0)
{
a=a.substring(1);
...
{
E(e[c],function(i){
collectXmailParams(b,c,i);
});
}
else{
collectXmailParams(b,c,e[c]);
}
}
}
var f=b.join('&');
var g='https://wx.mail.qq.com/'+a;
if(g.indexOf('?')===-1)
{
g+='?';
}
...
g+='r='+getXmailRandomString()+'&sid='+h;
QMAjax.send(g,{xhr:createXMLHttpRequest(),content:f,method:"POST",onload:d});
}
...
a.location.href=b+(b.indexOf('?')!==-1?'&':'?')+'sid='+c.xmailSid;
});
}
...
l=5;
var g=q.length;
for(var y=0,h=r.length-1;y<h;y++)
{
var e=false;
for(var D=0;D<=y&&D<g;D++)
{
if(!q[D].disabled&&q[D].value.indexOf(r[y])!=-1)
{
q[D].disabled=true;
e=true;
try{
...
{
q[D].parentNode.childNodes[1].innerText=r[y];
}
}
catch(p)
{
...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor493ddf.js"]);
...
var a={'comm2010.css':'$css_path$comm20104e71e5.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
