...
_goStatic._TEMPLATE._INFOCARD_DETAIL=TE(['<div class="profile_inner">','<img src="$icon$" title="" class="iconMask_gray" />','<div class="nowrap">','<span id="span_displayname_$email$" class="green bold b_size txtflow ','$@$if($addrvip$=="")$@$','tip_dispname_long ','$@$else$@$','tip_dispname_short ','$@$endif$@$','" title="$attrname$" ','$@$if($addrvip$!="")$@$','style="float: left; margin-right: 4px;"','$@$endif$@$','>','$dispname$','</span>','$@$if($qqnum$)$@$','<span class="graytext" style="float: left; margin-right:4px; _line-height: 16px;">($qqnum$)</span>','$@$endif$@$','$@$if($addrvip$!=""&&$btnnum$!=0)$@$','<span class="tip_iclist_ico_wrap" id="addVipAddr_$email$" ','style="vertical-align: 0;*vertical-align: -2px;_vertical-align: -3px;','$@$if($addrvip$=="true")$@$','display: none;','$@$endif$@$','"','>','<span class="tip_iclist_ico_btn" title="\u8BBE\u4E3A\u91CD\u8981\u8054\u7CFB\u4EBA"></span>','</span>','<span class="tip_iclist_ico_wrap tip_iclist_ico_wrap_vip" id="delVipAddr_$email$" ','style="vertical-align: 0;*vertical-align: -2px;_vertical-align: -3px;','$@$if($addrvip$=="false")$@$','display: none;','$@$endif$@$','"','>','<span class="tip_iclist_ico_btn" title="\u79FB\u9664\u91CD\u8981\u8054\u7CFB\u4EBA"></span>','</span>','$@$endif$@$','</div>','<div class="profile_inner_info">','$@$if(!$issys$)$@$','<a href="javascript:;" onclick=\'getTop().QMProfileTips.oper("mailTo","$_id$","$@$eval htmlEncode($email$)$@$", "$showinfo$", "$jsname$")\' class="graytext pointer accountFrom" title="\u7ED9TA\u5199\u4FE1" style="margin-right:9px;">$dispemail$</a>','$@$else$@$','<span class="graytext" title="$dispemail$" style="margin-right:9px;">$dispemail$</span>','$@$endif$@$','$@$if($email$!="10000@qq.com")$@$','<a class="pointer" ck="checkContactsEmails" style="display:inline-block;" href="/cgi-bin/mail_list?sid=$sid$&s=searchcontact&sender=','$@$eval encodeURIComponent($email$)$@$','&receiver=$@$eval encodeURIComponent($email$)$@$','&name=$name$&matchtype=include&folderid=all&page=0&AddrID=$AddrId$&grpid=$grpid$&category=all&from=profile&loc=profile,searchcontact,0,0">\u5F80\u6765\u90AE\u4EF6</a>','$@$endif$@$','</div>','</div>','$@$if($bindLinkedIn$=="true")$@$',_goStatic._TEMPLATE._LINKEDIN_DETAIL,'$@$endif$@$',_goStatic._TEMPLATE._OPERPANEL]);
